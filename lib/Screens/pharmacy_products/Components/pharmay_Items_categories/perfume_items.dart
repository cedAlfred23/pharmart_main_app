  ...
  @override
   Widget build(BuildContext context) {
    return Padding(
      ...
      itemCount: value.personalItems.length,
      ...
      itemBuilder: ((context, index) => ItemCard(
        title: value.personalItems[index][1],
        price: value.personalItems[index][3],
        image: value.personalItems[index][2],
      press: () => Navigator.push(
        context, 
        MaterialPageRoute(builder: (context) => DetailPage(product: value.personalItems[index]))
      )
      )),
    );
            },)
