...
// import '../pharmacy_products/Models/seachplaces.dart';
...
//     return Scaffold(
//       body:
//       // currentLocation == null? const Center(child: CupertinoActivityIndicator(radius: 15,),) : 
//       Stack(
//         children: [
//           Container(
//             height: h,
...
//         },
//         initialCameraPosition: const CameraPosition(target: sourceLocation, zoom: 12),
//         polylines: {
//       Polyline(
...
import 'package:google_maps_flutter/google_maps_flutter.dart';
import '../pharmacy_products/Models/auto_complete_result.dart';
import '../pharmacy_products/Models/seachplaces.dart';
import '../pharmacy_products/Models/map_services.dart';
...
//Markers set
  ...
  final key = 'AIzaSyA61DuuaGYbyFWFk4BT1uaQL_yIaIbhErc';
    ...
    return Scaffold(
      body: Stack(
        children: [
                          ...
                          _debounce = Timer(Duration(milliseconds: 700),
                            ...
                            if (value.length > 2) {
                              ...
                              List<AutoCompleteResult> searchResults =
                                  (await MapServices().searchPlaces(value)).cast<AutoCompleteResult>();
          ...
          getDirections
              ? Padding(
                  padding: EdgeInsets.fromLTRB(15.0, 60.0, 15.0, 5),
                  child: Column(children: [
                    Container(
                      height: 50.0,
                      decoration: BoxDecoration(
                    ...
                    child: Row(
                      children: [
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            title: const Text('Aleert'),
                            content: const Text("That all places. You can increase the range to load more!"),
                            actions: [
                              TextButton(
